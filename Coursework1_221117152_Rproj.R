...
gb_exercise <- read.csv("C:/Users/rache/OneDrive/Desktop/Year 4/Sem 2 - Time series/Coursework1_221117152/GB_exercise_searchHistory.csv")
...
p_filtered <- p[p$ds <= as.Date("2026-03-01"), ]
